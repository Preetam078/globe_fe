...
export function Globe({
  ...
  useEffect(() => {
    ...
    // Combine arc points with standalone points
    const standalonePoints = points || [];
    const allPoints = [...arcPoints, ...standalonePoints];

    // remove duplicates for same lat and lng
    const filteredPoints = allPoints.filter((v, i, a) =>
      a.findIndex((v2) =>
